...
func TestNodeMetricsReportCPUMetricsAsInt(t *testing.T) {
	// disable the featuregate
	featuregate.Apply(map[string]bool{reportCPUMetetricsAsDouble: false})
	n := newNode("1")
...
func TestNodeMetricsReportCPUMetricsAsDouble(t *testing.T) {
	...
	featuregate.Apply(map[string]bool{reportCPUMetetricsAsDouble: true})
	n := newNode("1")
